...
public class Tracker {
    ...
    private final static SimpleDateFormat dateFormat = new SimpleDateFormat("M-d-yyyy HH:mm:ss");

    public final static String TAG = Tracker.class.getSimpleName();
...
//            Log.d(TAG, "Launch Activity :" + pm.getLaunchIntentForPackage(packageInfo.packageName));
    ...
    public static UsageEvents getUsageEvents(Context context){
        ...
        return usm.queryEvents(0, System.currentTimeMillis());
    }

    public static List<UsageStats> getUsageStatsList(Context context){
        UsageStatsManager usm = (UsageStatsManager) context.getSystemService("usagestats");
        return usm.queryUsageStats(UsageStatsManager.INTERVAL_MONTHLY,
    ...
    public static HashMap<ForegroundEvent, Integer> calcEventPerHour(UsageEvents uEvents, long startPoint){
...
//        }
    ...
    public static long calcEventStartPoint(UsageEvents uEvents){
        UsageEvents.Event e = new UsageEvents.Event();
    ...
    private static boolean isSameDate(long date1, long date2) {
